...
if "filter_time" not in st.session_state:
    st.session_state.filter_time = datetime.datetime.now().time()
if "filter_date" not in st.session_state:
    st.session_state.filter_date = datetime.datetime.now().date()
...
if site_access_file and rms_file and current_alarms_file:
    ...
    filter_datetime = datetime.datetime.combine(st.session_state.filter_date, st.session_state.filter_time)
